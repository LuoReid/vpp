    ...
    <div class="main">
      <div class="login-pancel">
        <div class="login-form">
          ...
          <a-form-model :model="ruleForm" :rules="rules" ref="ruleForm" class="form-pancel">
            <a-form-model-item label prop="login_name">
              <a-input class="login-input" v-model="ruleForm.login_name" :autofocus="true" placeholder="Email" clearable></a-input>
            </a-form-model-item>
            <a-form-model-item label prop="password">
              <a-input class="login-input" v-model="ruleForm.password" type="password" placeholder="Password" clearable @keyup.enter.native="login"></a-input>
            </a-form-model-item>
            <a-form-model-item>
              <div class="login-btn">
                <a-button class="btn-confirm" :class="{ filled: formFilled }" @click="loginsubmit('ruleForm')" type="success">Login</a-button>
              </div>
            </a-form-model-item>
            <a-form-model-item>
